...
public class OpeningStockRpt extends Window{
	private AbsoluteLayout mainLayout;
	
	private CommonButton commonButton = new CommonButton("", "", "", "", "", "", "", "Preview", "", "Exit");
	...
	public OpeningStockRpt(){
		...
		this.setModal(false);
		this.center();
		this.setCaption("OPENING STOCK REPORT :: M. S. TYRE HOUSE");
