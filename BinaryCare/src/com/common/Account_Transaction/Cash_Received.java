...
public class Cash_Received extends Window{
	
	AbsoluteLayout mainLayout;
	
	private Label lblReceivedFrom,lblCashAC,lblBalance,lblBudget,lblDate,lblVoucherNo,lblDescription;
	
	private TextField txtReceivedFrom,txtVoucherNo;
	...
	public Cash_Received() {
		...
		this.setModal(false);
		this.center();
		this.setCaption("CASH RECEIVED VOUCHER :: M. S. TYRE HOUSE");
	...
	private AbsoluteLayout buildMainLayout(){
		...
		mainLayout.addComponent(lblReceivedFrom, "top:20px;left:20px;");
		
		txtReceivedFrom=new TextField();
		txtReceivedFrom.setWidth("180px");
		txtReceivedFrom.setHeight("-1px");
		txtReceivedFrom.setImmediate(true);
		mainLayout.addComponent(txtReceivedFrom, "top:20px;left:115px;");
		...
		mainLayout.addComponent(lblDescription, "top:240px;left:20px;");
		...
		mainLayout.addComponent(cmbDescription, "top:240px;left:100px;");

		mainLayout.addComponent(commonButton, "top:290px;left:110px;");
