...
public class Bank_Payment extends Window{
	
	AbsoluteLayout mainLayout;
	
	private Label lblType,lblPaidTo,lblPaymentBankAC,lblBalance,lblBudget,lblDate,lblVoucherNo,lblDescription,
	lblChequeNo,lblChequeDate;
	...
	private ComboBox cmbPaymentBankAC,cmbCheckNo,cmbDescription;
	...
	private AbsoluteLayout buildMainLayout(){
		...
		mainLayout.addComponent(lblPaidTo, "top:45px;left:20px;");
		
		txtPaidTo=new TextField();
		txtPaidTo.setWidth("180px");
		txtPaidTo.setHeight("-1px");
		txtPaidTo.setImmediate(true);
		mainLayout.addComponent(txtPaidTo, "top:45px;left:128px;");
		
		lblPaymentBankAC = new Label("Payment Bank AC :");
		mainLayout.addComponent(lblPaymentBankAC, "top:70px;left:20px;");
		
		cmbPaymentBankAC=new ComboBox();
		cmbPaymentBankAC.setWidth("270px");
		cmbPaymentBankAC.setHeight("-1px");
		cmbPaymentBankAC.setImmediate(true);
		mainLayout.addComponent(cmbPaymentBankAC, "top:70px;left:128px;");
		...
		mainLayout.addComponent(btnBankHead,"top:70px;left:403px;");
		...
		mainLayout.addComponent(txtBudget, "top:97px;left:128px;");
		
		lblBalance=new Label("Balance :");
		mainLayout.addComponent(lblBalance, "top:95px;left:256px;");

		txtBalance=new TextRead();
		txtBalance.setWidth("120px");
		txtBalance.setHeight("-1px");
		txtBalance.setImmediate(true);
		mainLayout.addComponent(txtBalance, "top:97px;left:311px;");
		...
		mainLayout.addComponent(lblChequeNo, "top:72px;left:450px;");

		cmbCheckNo=new ComboBox();
		cmbCheckNo.setWidth("120px");
		cmbCheckNo.setHeight("-1px");
		cmbCheckNo.setImmediate(true);
		cmbCheckNo.setNewItemsAllowed(false);
		cmbCheckNo.setFilteringMode(ComboBox.FILTERINGMODE_CONTAINS);
		mainLayout.addComponent(cmbCheckNo, "top:72px;left:530px;");

		lblChequeDate=new Label("Cheque Date :");
		mainLayout.addComponent(lblChequeDate, "top:97px;left:450px;");
		...
		mainLayout.addComponent(dChequeDate, "top:97px;left:530px;");
