...
public class PartyInfo extends Window{

	AbsoluteLayout mainLayout;
	
	Label lblPartyCode,lblpartyName,lblAddress,lblTelephone,lblMobile,lblFax,lblEmail,lblContactPerson,
	lblDesignation,lblPersonalMobile,lblIsActive,lblCreditPeriod,lblOpeningBalance,lblDebitAmount,
	lblCreditAmount,lblPartyName;

	private TextField txtPartyCode, txtPartyName,txtTelephone,txtMobile,txtFax,txtEmail,
	...
	public PartyInfo(){
		...
		this.setModal(false);
		this.center();
		this.setCaption("PARTY INFORMATION :: M. S. TYRE HOUSE");
	...
	private AbsoluteLayout buildMainLayout(){
		...
		mainLayout.addComponent(lblPartyName, "top:5px;left:20px");

		cmbPartyName=new ComboBox();
		cmbPartyName.setWidth("250px");
		cmbPartyName.setInputPrompt("search here...");
		cmbPartyName.setImmediate(true);
		cmbPartyName.setFilteringMode(ComboBox.FILTERINGMODE_CONTAINS);
		mainLayout.addComponent(cmbPartyName,"top:22px; left:20px");
		...
		lblPartyCode=new Label("Dealer/Party Code :");
		mainLayout.addComponent(lblPartyCode, "top:25px;left:300px");
		
		txtPartyCode=new TextField();
		txtPartyCode.setWidth("170px");
		txtPartyCode.setHeight("25px");
		txtPartyCode.setImmediate(true);
		mainLayout.addComponent(txtPartyCode, "top:22px;left:430px");
		
		lblPartyName=new Label("Dealer/Party Name :");
		mainLayout.addComponent(lblPartyName, "top:51px;left:300px");
		
		txtPartyName=new TextField();
		txtPartyName.setWidth("320px");
		txtPartyName.setHeight("25px");
		txtPartyName.setImmediate(true);
		mainLayout.addComponent(txtPartyName, "top:48px;left:430px");
